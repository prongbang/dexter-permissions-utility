...
open class DexterPermissionsUtility(
    ...
    override fun isAccessGalleryGranted(permissionsChecker: PermissionsChecker) {
        permissionsCheckerListener.listener(
            listOf(
    ...
    override fun isNotificationGranted(permissionsChecker: PermissionsChecker) {
        permissionsCheckerListener.listener(
    ...
    override fun checkNotificationGranted(permissionsGranted: PermissionsGranted) {
        singleCheck("android.permission.POST_NOTIFICATIONS", permissionsGranted)
    }
